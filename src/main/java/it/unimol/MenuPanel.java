...
public class MenuPanel extends JPanel {
        ...
        addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent e) {
                if (e.getKeyCode() == KeyEvent.VK_SPACE) {
                    gameFrame.showGamePanel();  // Avvia il gioco quando viene premuto il tasto spazio
                }
            }
        });
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        g.drawString("High Score: " + gameLogic.getHighScore(), (SCREEN_WIDTH - metrics1.stringWidth("High Score: " + gameLogic.getHighScore())) / 2, SCREEN_HEIGHT / 3);
        ...
        g.drawString("Total Games Played: " + gameLogic.getTotalGamesPlayed(), SCREEN_WIDTH / 2 + 100 , SCREEN_HEIGHT / 2 + 110);
        g.drawString("Total Apples Eaten: " + gameLogic.getTotalApplesEaten(), SCREEN_WIDTH / 2 + 100, SCREEN_HEIGHT / 2 + 130);
        g.drawString("Total Bad Apples Eaten: " + gameLogic.getTotalBadApplesEaten(), SCREEN_WIDTH / 2  + 100, SCREEN_HEIGHT / 2 + 150);
        g.drawString("Total Golden Apples Eaten: " + gameLogic.getTotalGoldenApplesEaten(), SCREEN_WIDTH / 2 + 100, SCREEN_HEIGHT / 2 + 170);
